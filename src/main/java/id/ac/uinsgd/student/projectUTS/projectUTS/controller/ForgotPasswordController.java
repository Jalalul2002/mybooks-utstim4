...
import id.ac.uinsgd.student.projectUTS.projectUTS.entity.Mail;
import id.ac.uinsgd.student.projectUTS.projectUTS.entity.PasswordForgot;
...
import id.ac.uinsgd.student.projectUTS.projectUTS.service.framework.EmailService;
import id.ac.uinsgd.student.projectUTS.projectUTS.service.framework.PasswordResetTokenService;
import id.ac.uinsgd.student.projectUTS.projectUTS.service.framework.UserService;
...
public class ForgotPasswordController {
    ...
    public String processPasswordForgot(@Valid @ModelAttribute("passwordForgot") PasswordForgot passwordForgot, BindingResult result, Model model, RedirectAttributes attributes, HttpServletRequest request) {
        ...
        mailModel.put("signature", "http://github.com/Jalalul2002");
